...
export function PosOrderPanel({
  ...
  return (
    <aside
      className={cn(
        "flex min-h-0 w-full flex-col border-pos-border-subtle bg-pos-depth/50 backdrop-blur-xl xl:w-96 xl:border-l",
        className,
      )}
      aria-label="Panier et commande"
    >
      <div className="border-b border-pos-border-subtle px-5 pb-2 pt-5">
      ...
      <div className="border-b border-pos-border-subtle p-4">
      ...
      <div className="min-h-0 shrink-0 border-b border-pos-border-subtle px-4 pb-3 pt-1">
        <div
          className={cn(
            "overflow-hidden transition-[max-height,opacity,margin] duration-300 motion-reduce:transition-none",
            panelEase,
            isTakeaway ? "max-h-[32rem] opacity-100" : "max-h-0 opacity-0 pointer-events-none",
          )}
        >
          <div className={cn("pt-2", !isTakeaway && "pointer-events-none")}>
        ...
        <div
          className={cn(
            "overflow-hidden transition-[max-height,opacity,margin] duration-300 motion-reduce:transition-none",
            panelEase,
            orderType === "dine-in" ? "max-h-32 opacity-100" : "max-h-0 opacity-0 pointer-events-none",
          )}
        >
          <div className={cn("pt-2", orderType !== "dine-in" && "pointer-events-none")}>
            ...
            {lines.map((line) => (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between gap-2">
                  ...
                  <span className="text-base font-bold tabular-nums text-pos-neon-magenta">{formatDa(line.lineTotalDa)}</span>
                </div>
              </li>
            ))}
          </ul>
      ...
      <div className="mt-auto border-t border-pos-border-subtle bg-pos-depth/80 p-5">
