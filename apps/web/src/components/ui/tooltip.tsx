...
>(({ className, sideOffset = 10, children, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        "z-[200] max-w-[14rem] rounded-lg border border-slate-600/50 bg-[#141b2d] px-3 py-1.5 text-xs font-semibold tracking-tight text-slate-100 shadow-[0_10px_40px_-8px_rgba(0,0,0,0.55)]",
